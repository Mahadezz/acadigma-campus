...
| [`2026-09-24-rls-known-gaps.md`](test-reports/2026-09-24-rls-known-gaps.md)                   | D-56, PR #17 `KNOWN_GAPS` shrink: isolation + escalation pgTAP for `consent_records`, `legal_acceptances`, `email_log`, `file_access_log`, `subscription_events` — the new `14_rls_known_gaps.sql`.                                     |
