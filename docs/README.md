...
| [`2026-09-25-F-OP-03-p1-p2.md`](test-reports/2026-09-25-F-OP-03-p1-p2.md)                           | F-OP-03 Parts 1-2 (D-204, D-205): the PDF foundation (`@acadigma/pdf` — Hind Siliguri + Inter, document shell, golden Bengali-conjunct test) and the run pipeline (`report_runs`/`report_run_items`, `createReportRun`, `GET /api/pdf/[runId]`, `40_report_runs.sql`).                                        |
