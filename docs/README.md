...
| [`2026-09-25-F-CM-06-require-writable.md`](test-reports/2026-09-25-F-CM-06-require-writable.md) | D-300: read-only mode refuses every tenant write — `requireWritable` in `updateSchoolSettings`, the `app.tg_require_writable()` trigger on every tenant table, `scripts/check-require-writable.mjs` and `50_require_writable.sql` so nothing new skips it.                                                     |
