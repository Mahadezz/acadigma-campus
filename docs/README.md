...
| [`2026-09-25-F-ID-05-p1.md`](test-reports/2026-09-25-F-ID-05-p1.md)                           | F-ID-05 Part 1: automatic personal workspace at registration — confirms the M0 `handle_new_user()`/`tg_workspace_bootstrap()` bootstrap already met the spec, and adds the missing `workspaces_one_personal_per_creator` partial unique index plus `13_personal_workspace_registration.sql`. |
