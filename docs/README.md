...
| [`2026-09-25-F-ID-05-p2.md`](test-reports/2026-09-25-F-ID-05-p2.md)                           | F-ID-05 Part 2: the `/onboarding` shell, chooser and state — `onboarding_progress` + RLS, `getOnboardingState`/`saveOnboardingDraft`/`completeOnboarding`, the forced-access redirect matrix, `16_onboarding_progress.sql`.                                                                         |
