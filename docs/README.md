...
| [`2026-09-25-design-bn-shell.md`](test-reports/2026-09-25-design-bn-shell.md)                       | D-401: the `acadigma_locale` cookie now covers the whole signed-in shell (nav, top bar, `UserMenu` language switch, read-only banner, dashboard, settings, 404/error pages), `<html lang>` wired, Western-digit `Intl` formatting (`toIntlLocale`), en/bn key-parity + bn-BD guard tests. No migration.        |
