...
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Area             | ops                                                                                                                                                                                                                                                                                             |
| Status           | in-progress — `resolve()` + defaults + read/patch repository + server action landed (`feat/m0-settings-notifications`); rest of Part 1 (RLS, `school_public_settings` view, settings shell UI, profile form, branding preview) not started. See `docs/test-reports/2026-09-17-M0-gates.md`.     |
