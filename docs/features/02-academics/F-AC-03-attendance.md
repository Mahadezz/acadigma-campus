...
- **Not built yet:** policy screen (Part 1), copy-yesterday, reminders and the absent-guardian notification (Part 3), locking and correction requests (Part 4), register and rollup (Part 5), alerts (Part 6), the scan hook (Part 7; the offline queue itself is built as F-ID-11 Part 2a, D-309), the parent policy (F-AC-10).
