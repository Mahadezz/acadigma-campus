...
| CI run         | [run 36131309967](https://github.com/Mahadezz/acadigma-campus/actions/runs/36131309967) — all jobs pass (`db`/`guard`/`e2e`'s live-Supabase specs skip per OQ-27, as on every PR)                                                                                                                                                                                                                                                                                                                                               |
