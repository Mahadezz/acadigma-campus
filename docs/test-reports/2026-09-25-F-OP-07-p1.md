...
Local run, `pnpm test` on Windows: **79 files, 896 tests, all passed** (whole repo, after merging origin/main with #32 and #36, including review fixes). The new suites:
