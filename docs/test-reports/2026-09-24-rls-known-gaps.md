...
65 assertions total (`plan(65)`), one file, self-contained fixtures (`tests.mkuser`/`login`/`logout` duplicated per house style), everything inside `begin`/`rollback`.
...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- |
| 1   | `notifications`' assertions were written from the migration text and reviewed by eye before ever running — resolved: CI's `db` job ran them for real, all 65 assertions passed (§4, §10)                                                                                                                                                                                                                     | ~~high~~ resolved | —                                                                                                                                                                                                      | —       |
