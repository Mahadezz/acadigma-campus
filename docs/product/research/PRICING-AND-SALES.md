...
| ------------------------------------------------------------- | ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Sheba Shikkha** (Sheba Digital Ltd)                         | Per student / month                                     | Basic **৳10**, Standard **৳15**, Premium **৳20** per student per month                                                           | not published                        | "SMS Service" bundled in all three tiers                                        | Claims 200+ schools, 500,000+ active students, 40+ districts. All three tiers list _identical_ features — the ladder is service level, not functionality  | [shebashikkha.com](https://shebashikkha.com/)                                                                                                                                                    |
...
| **Teachmint**                    | India                   | Free-forever tier + custom enterprise quote          | Not published                                                                                                                               | —                                    | [saasworthy](https://www.saasworthy.com/product/teachmint/pricing)                                                                                                |
...
Assumptions: 10% of teachers buy, 3 items/year each, at 1,000 schools. Compare to subscription revenue at 1,000 schools (~৳3.8M/**month**): **the marketplace is ~0.6% of revenue.**
...
| Blended ARPA (recommended pricing, §10) | **৳3,800/month**                                                                                         | mix of Starter/Pro at typical band sizes                                                 |
...
**Blended AI cost ≈ ৳1.20 per action × 300 actions = ৳360 per school per month** — **9.5% of ARPA**. Without caching, batching and model routing, the same volume on Sonnet 5 at 3k/2k would be ~৳900/school/month = **24% of ARPA**, and an unmetered Free tier could exceed the plan price outright. _This is the single most important cost control in the product._
...
Per school per month, at blended ARPA **৳3,800**:
...
**Read:** a healthy but not-quite-classic-SaaS 72–77%. The gap to the 85% SaaS benchmark is AI (9.5%) plus BD's high-touch support requirement. Both are the price of winning this market — do not try to engineer them away by shipping worse support.
...
**Payback.** At ৳2,750 gross profit/month, a **৳10,500 fully-loaded founder CAC pays back in 3.8 months**. Even a ৳20,000 CAC pays back in 7.3 months. This is an unusually forgiving market — the constraint is founder hours, not money.

**LTV.** School ERP churn is low once fees, SMS and results run through the system (data lock-in + parents trained + staff retrained cost). At **15% annual logo churn** _(est.)_ → 6.7-year life → **LTV ≈ ৳220,000**, LTV/CAC ≈ **21×**. Even at a pessimistic 30% churn: LTV ৳110,000, ratio **10×**. Both are far above the 3× threshold; the model is not the risk, execution capacity is.
...
**Adopt Option C. Keep four plan names; change what sits behind them.**

| Plan           | Base / month     | Included students | Above included        | Purpose                                                                                                                                                                                        |
| -------------- | ---------------- | ----------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Free**       | ৳0               | up to **60**      | — (hard cap)          | Kindergartens, coaching centres, independent tutors. 1 admin + 3 teachers, 20 AI actions/month, no SMS, watermarked PDFs. This is the marketplace and hiring-network seed, not a revenue tier. |
| **Starter**    | **৳1,500**       | up to **150**     | **+৳6/student/month** | Small private schools and KGs. Attendance, students, exams, report cards, parent portal, 200 AI actions/month pool.                                                                            |
| **Pro**        | **৳3,500**       | up to **300**     | **+৳8/student/month** | The default. Everything in Starter + AI credits pool (1,000/month), hiring, cover teacher, analytics, marketplace school-funded purchasing, priority support. **14-day trial.**                |
| **Enterprise** | **from ৳12,000** | custom            | custom                | Multi-campus, SLA, on-site training, white-label option, dedicated onboarding.                                                                                                                 |

**Supporting terms:**

| Term                       | Value                                        | Rationale                                                                                                                 |
| -------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| **Onboarding fee**         | **৳5,000 one-time**, waived on annual prepay | BD norm (Edufy ৳2,000–5,000); funds data migration + two training sessions; the waiver is your annual-prepay lever        |
| **Annual prepay**          | **2 months free (16.7% off)**                | Removes 11 collection failure points; matches EduGradUP's multi-year discount logic; cash up front for a solo founder     |
| **SMS**                    | **৳0.35/SMS**, 500 included/month on Pro     | Costs ৳0.25–0.45; do **not** promise unlimited the way Bidyaan does                                                       |
| **AI top-up packs**        | ৳500 per 500 actions                         | ~৳1 revenue per ৳1.20 cost action at the margin — priced to discourage abuse, not to profit                               |
| **Marketplace commission** | **30%**, unchanged                           | Sits between TpT Basic (45%) and TpT Premium (20%); generous enough to attract sellers, high enough to be worth operating |
| **Reseller**               | **100% of months 1–3 + 10% recurring**       | Not 20–25% recurring (India norm) — that halves gross margin permanently                                                  |

**Where this lands against the market:**

| School size  | Incumbent at ৳10/student | Incumbent at ৳15 | **Acadigma recommended**               | Position                                |
| ------------ | ------------------------ | ---------------- | -------------------------------------- | --------------------------------------- |
| 60 (tiny KG) | ৳600                     | ৳900             | **৳0 (Free)**                          | Unbeatable — nobody serves this segment |
| 150          | ৳1,500                   | ৳2,250           | **৳1,500 (Starter)**                   | At market, with AI                      |
| 300          | ৳3,000                   | ৳4,500           | **৳3,500 (Pro)**                       | ~17% above the ৳10 floor, 22% under ৳15 |
| 500          | ৳5,000                   | ৳7,500           | **৳5,100 (Pro)**                       | At the floor                            |
| 800          | ৳8,000                   | ৳12,000          | **৳7,500 (Pro)**                       | 6% under the floor                      |
| 1,500        | ৳15,000                  | ৳22,500          | **৳13,100 (Pro)** → move to Enterprise | 13% under the floor                     |

Acadigma is at or below the cheapest incumbent at every size above 300 students, free below 60, and at parity in between — **so the sale is never about price.** It is about the phone-first attendance, Bengali report cards, and the AI. That is exactly where you want the conversation.

**Do not** advertise a per-student rate. Publish the grid, quote a monthly number, and let the principal do the division themselves if they want to.
