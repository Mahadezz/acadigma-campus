...
1. **The Bangladeshi school-OS market has no incumbent with a defensible reputation.** `[EVIDENCE]` The category leader by review volume, ClassTune, sits at **3.18★ across 2,743 ratings and has not shipped an update since 14 June 2024**. Every other BD competitor has under 120 ratings. `[INFERENCE]` Acadigma's realistic competitive moat in year one is not features — it is _an app that opens, logs you in once, and loads fast_. That should be the launch positioning.
